...
<div class="container-fluid nav-bar p-0">
    <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
        <a href="{{ url('/') }}" class="navbar-brand p-0">
            <h1 class="display-5 text-secondary m-0"><img src="img/brand-logo.png" class="img-fluid" alt="">WilTavel</h1>
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="{{ url('/assistance') }}" class="dropdown-item">Expert</a>                  
                        <a href="{{ url('/temoignage') }}" class="dropdown-item">Temoignage</a>
                        {{-- <a href="{{ url('/a-venir') }}" class="dropdown-item">à vénir</a> --}}
